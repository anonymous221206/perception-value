...
set -e
export NUPLAN_DEVKIT_ROOT=third_party/nuplan_devkit
export NUPLAN_DATA_ROOT="${RAP_DATASETS:-datasets}/nuplan"
export NUPLAN_MAPS_ROOT="${RAP_DATASETS:-datasets}/nuplan/nuplan-maps-v1.0"
export NUPLAN_EXP_ROOT=data/cache/nuplan_exp
export NUPLAN_SIMULATION_ALLOW_ANY_BUILDER=1
mkdir -p "$NUPLAN_EXP_ROOT"
PY="environment/bin/py-nuplan"
