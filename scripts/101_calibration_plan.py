...
Pre-registered in the pre-registration record (not part of this release) (2026-09-14, "Task 1 pre-registration").  For each geometry and
...
share one (the single-process version ran out of CUDA memory; the pre-registration record 11:03):
