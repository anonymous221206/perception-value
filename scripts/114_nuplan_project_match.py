...
Pre-registered in the pre-registration record (not part of this release) (2026-09-14 14:44).  For every Track B state and each of its four
...
summary, the projection checks and 20 overlays.  Run with environment/bin/py-nuplan.
"""
...
DB_DIR = Path(str(_DS / "nuplan/nuplan-v1.1/splits/mini"))
IMG_ROOT = Path(str(_DS / "nuplan/sensor_blobs_cam_f0"))
...
class Camera:
    ...
    def ground_point(self, u, v, ground_z):
        ...
        (the pre-registration record, Task 5 amendment): ground_z is the train+val median bottom of vehicle boxes.
        """
...
def main():
    ...
    ap.add_argument("--data_root", default=str(_DS / "nuplan"))
    ap.add_argument("--map_root", default=str(_DS / "nuplan/nuplan-maps-v1.0"))
