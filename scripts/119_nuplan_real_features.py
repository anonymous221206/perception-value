...
Pre-registered in the pre-registration record (not part of this release) (Task 7 pre-registration).  The CHEAP-branch observation is exactly what
...
and the recomputed `crit_sum_gt` equals the benchmark's existing column.  Run with environment/bin/py-nuplan.
"""
...
def main():
    ...
    builder = m91.NuPlanScenarioBuilder(
        data_root=str(_DS / "nuplan/nuplan-v1.1/splits/mini"),
        map_root=str(_DS / "nuplan/nuplan-maps-v1.0"),
