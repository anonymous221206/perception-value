...
Pre-registered in the pre-registration record (not part of this release) (2026-09-13 23:55), splits in configs/benchmark_splits.json.
...
from rap.scoring import EPS, QUOTAS, ci, evaluate, quota_k, topk_expect   # noqa: E402,F401  (t92.* for other stages)
...
# ----------------------------------------------------------------------------------------------
# statistic: rap.scoring (moved there verbatim for the submission path, Task 25)
