...
Pre-registered in the pre-registration record (not part of this release) (2026-09-14, "Task 2 pre-registration").
...
(the pre-registration record 12:55), most likely because trtexec's default workspace -- the whole device memory --
...
KITTI_IMG = Path(str(_DS / "kitti_tracking/training/image_02"))
