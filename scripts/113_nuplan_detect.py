...
Pre-registered in the pre-registration record (not part of this release) (2026-09-14 14:44).  The engines are the nuScenes pair, 192x320 and
...
if __name__ == "__main__":
    ...
    warn_if_not_reference("113_nuplan_detect.py", strict=True)
...
def main():
    ...
    ap.add_argument("--weights", default=str(_MD / "yolov8s.pt"))
