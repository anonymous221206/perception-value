...
Pre-registered in the pre-registration record (not part of this release) (2026-09-14 14:44).  `make_planner`, `score` and `filtered_history` are
...
Checkpointed per scenario.  Run with environment/bin/py-nuplan, one planner per process.
"""
